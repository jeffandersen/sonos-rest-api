...
router.get('/players/:name/queue', function(req, res, next) {
...
router.all('/players/:name/:action', allowPostPatch, function(req, res, next) {
...
router.all('/zones/:uuid/:action', allowPostPatch, function(req, res, next) {
